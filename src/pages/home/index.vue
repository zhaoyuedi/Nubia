    ...
    <div id="nubiaindex">
            ...
            <div class="carousel">
                <Swiper v-if="carouselData.length > 0">
                    <Slide v-for="(item,index) in carouselData"
                           :key="index">
                        <router-link tag="li"
                                     :to="{name:'product',params:{product_id:item.product_id,spec_id:0 }}">
        ...
        <div class="show_img">
            ...
            <div class="show_img_right">
                <router-link tag="li"
                             :to="{name:'product',params:{product_id:showImgRT.product_id,spec_id:showImgRT.block_products.spec_id}}">
                    <a><img :src="showImgRT.small_image | addUrl"></a>
                </router-link>
                <router-link tag="li"
                             :to="{name:'product',params:{product_id:showImgRB.product_id,spec_id:showImgRB.block_products.spec_id}}">
        ...
        <div class="rxjx">
            <h2>热销机型</h2>
            <router-link tag="li"
                             :to="{name:'product',params:{product_id:rxjxImg.product_id,spec_id:rxjxImg.block_products.spec_id}}">
            <a>
        ...
        <div class="showAll">
            <div class="show_list"
                 ...
                 :key="index">
                <router-link tag="li"
                             :to="{name:'product',params:{product_id:item.product_id,spec_id:item.block_products.spec_id}}">
        ...
        <router-link tag="li"
                     :to="{name:'product',params:{product_id:jxpjImg.product_id,spec_id:jxpjImg.block_products.spec_id}}"
